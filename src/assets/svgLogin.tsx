export const SvgLogin = () => {
  return (
    ...
    >
      ...
      <circle cx="5.44828" cy="73.5517" r="5.44828" fill="#F2F2F2" />
      <circle cx="39.5" cy="73.5517" r="5.44828" fill="#F2F2F2" />
      <circle cx="73.5517" cy="73.5517" r="5.44828" fill="#F2F2F2" />
      <circle cx="141.655" cy="73.5517" r="5.44828" fill="#F2F2F2" />
      <circle cx="175.707" cy="73.5517" r="5.44828" fill="#F2F2F2" />
      <circle cx="107.603" cy="73.5517" r="5.44828" fill="#F2F2F2" />
    </svg>
  );
};
